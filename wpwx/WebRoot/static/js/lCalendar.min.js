...
window.lCalendar = function() {
    var a = function() { this.gearDate, this.minY = 1900, this.minM = 1, this.minD = 1, this.maxY = 2099, this.maxM = 12, this.maxD = 31 };
    return a.prototype = { init: function(a) {
            ...
            function g() {
                var a = new Date,
                    b = { hh: a.getHours(), mm: a.getMinutes() }; /^\d{2}:\d{2}$/.test(t.trigger.value) && (rs = t.trigger.value.match(/(^|:)\d{2}/g), b.hh = parseInt(rs[0].replace(/^0?/g, "")), b.mm = parseInt(rs[1].replace(/:0?/g, ""))), t.gearDate.querySelector(".time_hh").setAttribute("val", b.hh), t.gearDate.querySelector(".time_mm").setAttribute("val", b.mm), i() }
                    ...
                    switch (e > 8 && (e = 8, c = !0), a.dataset.datetype) {
                        ...
                        case "time_mm":
                            if (-110 > e && (e = -110, c = !0), c) {
                                var i = Math.abs(e - 8) / 2;
                                o(a, i), clearInterval(a["int_" + a.id]) } }
                    a["pos_" + a.id] = e, a.style["-webkit-transform"] = "translate3d(0," + e + "em,0)", a.setAttribute("top", e + "em"), b++ }, 30) }

            function o(a, b) { b = Math.round(b), a.setAttribute("val", b), /date/.test(a.dataset.datetype) ? h() : i() }
            ...
            var t = this;
            t.trigger.addEventListener("click", { date: b, datetime: d, time: f }[a]) } }, a }();
